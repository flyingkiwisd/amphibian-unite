...
/**
 * Generic localStorage-backed editable store.
 * Overlays user edits on top of default data.
 * Each view uses a unique storageKey prefix.
 */
  ...
  const [data, setDataState] = useState<T>(() => {
    ...
    try {
      ...
      if (stored) {
        ...
        // Deep merge for objects, direct replace for arrays
