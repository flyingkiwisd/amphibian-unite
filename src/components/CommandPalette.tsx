...
const navigationItems: SearchResult[] = [
  ...
  },
  {
    ...
    title: '14 Agents',
    subtitle: 'AI agent fleet management',
    category: 'Navigation',
    action: 'agents',
  },
  {
  ...
  },
  {
    ...
    title: 'OKRs & KPIs',
    subtitle: 'Objectives, key results, and metrics',
    category: 'Navigation',
    action: 'okrs',
  },
  {
    ...
    title: 'Tasks',
    subtitle: 'Task commander and project tracking',
    category: 'Navigation',
    action: 'tasks',
  },
  {
    ...
    title: 'Roadmap',
    subtitle: 'Strategic phases and milestones',
    category: 'Navigation',
    action: 'roadmap',
  },
  {
    ...
    title: 'AI Edge',
    subtitle: 'AI advantage layers and edge rating',
    category: 'Navigation',
    action: 'ai-edge',
  },
  {
    ...
    icon: <Target className="w-4 h-4" />,
    title: 'Leaderboard',
    subtitle: 'Team leaderboard, points, and incentives',
    category: 'Navigation',
    action: 'leaderboard',
  },
  {
    ...
    subtitle: 'Daily commitments and hit rate tracking',
    category: 'Navigation',
    action: 'accountability',
  },
  {
    id: 'nav-founder-alignment',
    icon: <Handshake className="w-4 h-4" />,
    title: 'Founder Alignment',
    subtitle: 'Weekly alignment scores and drift alerts',
    category: 'Navigation',
    action: 'founder-alignment',
  },
  {
    id: 'nav-meeting-intel',
  ...
  },
  {
    ...
    title: 'What Changed',
    subtitle: 'Daily digest of overnight changes',
    category: 'Navigation',
    action: 'what-changed',
  },
  {
    id: 'nav-peer-feedback',
    icon: <MessageCircle className="w-4 h-4" />,
    title: 'Peer Feedback',
    subtitle: 'Weekly collaboration micro-pulses',
    category: 'Navigation',
  ...
  },
  {
    ...
    title: 'LP Health',
    subtitle: 'LP relationship health scores and pipeline',
    category: 'Navigation',
    action: 'lp-health',
  },
  {
    id: 'nav-competitive-intel',
    icon: <Radar className="w-4 h-4" />,
    title: 'Competitive Intel',
    subtitle: 'Competitive intelligence feed and signals',
    category: 'Navigation',
  ...
  },
  {
    ...
    subtitle: 'Decision-OKR-Person-Risk connections',
    category: 'Navigation',
