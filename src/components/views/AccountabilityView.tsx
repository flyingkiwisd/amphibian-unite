    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-3xl font-bold">
              <span className="gradient-text">Accountability Loops</span>
            </h1>
          </div>
          <p className="text-text-secondary text-sm mt-1 max-w-xl">
            Track morning commitments against end-of-day results. Build consistency, measure follow-through.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-surface border border-border rounded-xl p-6 animate-fade-in" style={{ animationDelay: '325ms' }}>
          ...
          {/* Teal progress bar for overall week */}
          <div>
